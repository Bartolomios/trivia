...
const WelcomeView = () =>{
    ...
    const { getQuestions, getAmount } = bindActionCreators(actionCreators, dispatch); 
    ...
    const startGame = () =>{        
        ...
        fetchQuestions(5 , selected, getQuestions, dispatch); 
            ...
            <div className={styles.container}>        
              ...
              <div className={styles.form}>
                ...
                <Select options={options} selected={selected} setSelected={setSelected}/>
                 <div className={styles.label}>
                    <img className={styles.labelIcon} src={amountIcon} alt="amount icon"/>
                    <div className={styles.labelTitle}>Amount</div>
                </div>
                <input type="number" onChange={handleChange} className={styles.input} placeholder="Type number from 1 to 50"/>
